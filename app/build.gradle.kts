...
android {
    ...
    // Signing configuration â€” use debug keystore for both debug & release
    ...
    signingConfigs {
        ...
        create("release") {
            // Use debug keystore for release builds so the APK is installable
            // TODO: Replace with a proper release keystore for production
